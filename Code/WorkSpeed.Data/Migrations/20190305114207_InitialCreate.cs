        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Group = table.Column<string>(type: "varchar(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemVolume = table.Column<float>(type: "real", nullable: true, computedColumnSql: "[ItemWidth] * [ItemLength] * [ItemHeight] / 1000"),
                    ...
                    CartonVolume = table.Column<float>(type: "real", nullable: true, computedColumnSql: "[CartonWidth] * [CartonLength] * [CartonHeight] * [CartonQuantity] / 1000"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "-;", "Без должности", "-", 47.85m },
                    { 2, "гр.;гр;груз;грузч.;", "Грузчик", "Грузчик", 47.85m },
                    { 3, "кл.;кладовщик;кл;клад;клад.;", "Кладовщик на РРЦ", "Кладовщик склада", 52.64m },
                    { 4, "пр.;приёмщик;приемщик;пр;", "Кладовщик приемщик", "Кладовщик-приемщик", 57.42m },
                    { 5, "вод.;водитель;вод;карщик;", "Водитель погрузчика", "Водитель погрузчика", 52.64m },
                    { 6, "ст.кл.;старший;ст;ст.;старшийкладовщик;ст.клад.;", "Старший кладовщик на РРЦ", "Старший кладовщик склада", 62.21m },
                    { 7, "зам.пр.;зампоприёмке;зампр;", "Заместитель управляющего склада по отгрузке", "Менеджер по отправке груза", 95.70m },
                    { 8, "зам.отгр.;зампоотгрузке;замотгр;", "Заместитель управляющего склада по приемке", "Менеджер по приему груза", 92.22m },
                    { 9, "упр.скл.;управляющий;упр.;упр;упр.складом;", "Управляющий РРЦ", "Управляющий складом", 119.63m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 14, "дор.;дор;", 1f, "Дорогая" },
                    { 13, "рас.;расстановка;рас;", 1f, "Расстановка" },
                    { 11, "мез.3;мезонин3;мез3;", 1f, "Мезонин, 3-й этаж" },
                    { 10, "мез.2;мезонин2;мез2;", 1f, "Мезонин, 2-й этаж" },
                    { 9, "мез.1;мезонин1;мез1;", 1f, "Мезонин, 1-й этаж" },
                    { 8, "ст.см.мез.;ссммез;", 1f, "Старший смены, мезонин" },
                    { 12, "мез.4;мезонин4;мез4;", 1f, "Мезонин, 4-й этаж" },
                    { 6, "ст.см.кр.;ссмкр;", 1f, "Старший смены, крупняк" },
                    { 5, "вод.;водитель;вод;", 1f, "Водитель" },
                    { 4, "отгр.;отгр;от.;от;", 1f, "Отгрузка" },
                    { 3, "пр.;приемка;пр;", 1f, "Приёмка" },
                    { 2, "упр.;упр;склад;", 1f, "Склад" },
                    { 1, "-;", 1f, "-" },
                    { 7, "кр.;кр;", 1f, "Крупняк" }
                });
