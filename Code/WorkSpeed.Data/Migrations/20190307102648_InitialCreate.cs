        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, "зам.отгр.;зампоотгрузке;замотгр;", "Заместитель управляющего склада по отгрузке", "Менеджер по отправке груза", 95.70m },
                    { 8, "зам.пр.;зампоприёмке;зампр;", "Заместитель управляющего склада по приемке", "Менеджер по приему груза", 92.22m },
