    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 13, "вод.;водитель;вод;", 1f, "Водитель" },
                    { 12, "ст.см.кр.;ссмкр;", 1f, "Старший смены, крупняк" },
                    { 10, "рас.;расстановка;рас;", 1f, "Расстановка" },
                    { 9, "мез.4;мезонин4;мез4;", 1f, "Мезонин, 4-й этаж" },
                    { 8, "мез.3;мезонин3;мез3;", 1f, "Мезонин, 3-й этаж" },
                    { 7, "мез.2;мезонин2;мез2;", 1f, "Мезонин, 2-й этаж" },
                    { 11, "ст.см.мез.;ссммез;", 1f, "Старший смены, мезонин" },
                    { 5, "дор.;дор;", 1f, "Дорогая" },
                    { 4, "кр.;кр;", 1f, "Крупняк" },
                    { 3, "отгр.;отгр;от.;от;", 1f, "Отгрузка" },
                    { 2, "пр.;приемка;пр;", 1f, "Приёмка" },
                    { 1, "упр.;упр;склад;", 1f, "Склад" },
                    { 6, "мез.1;мезонин1;мез1;", 1f, "Мезонин, 1-й этаж" }
                });
