    ...
    public class OperationConfiguration : IEntityTypeConfiguration< Operation >
    {
        public void Configure ( EntityTypeBuilder< Operation > builder )
        {
            ...
            builder.HasData( new Operation[] {
                ...
                new Operation { Id = 3, Name = "Размещение товара",    Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 4, Name = "Перемещение товара",   Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 5, Name = "Подтоварка",           Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 6, Name = "Верт. дефрагментация", Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 7, Name = "Гор. дефрагментация",  Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                ...
                new Operation { Id = 10, Name = "Подбор товаров покупателей",    Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 11, Name = "Предварительный подбор товара", Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
                new Operation { Id = 12, Name = "Упаковка товара в места",       Group = OperationGroups.Gathering, Complexity = (float) 1.0 },
