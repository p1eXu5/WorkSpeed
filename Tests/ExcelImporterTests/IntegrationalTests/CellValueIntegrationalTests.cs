...
namespace ExcelImporter.Tests.IntegrationalTests
{
    ...
    public class CellValueIntegrationalTests
    {
        ...
        {
            // Arrange:
            var cellValue = new CellValue(GetMockedCell(value));
        ...
        {
            // Arrange:
            var cellValue = new CellValue(GetMockedCell(DateTime.Parse (value)));
        ...
        private ICell GetMockedCell (double value)
        {
        ...
        private ICell GetMockedCell (string value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
        ...
        private ICell GetMockedCell (bool value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
        ...
        private ICell GetMockedCell (DateTime value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
            cell.SetCellValue (value);
