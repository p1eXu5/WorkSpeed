...
namespace NpoiExcel.Tests.IntegrationalTests
{
    ...
    public class CellValueIntegrationalTests
    {
        ...
        {
            // Arrange:
            var cellValue = new CellValue(GetCell(value));
        ...
        {
            // Arrange:
            var cellValue = new CellValue(GetCell(DateTime.Parse (value)));
        ...
        private ICell GetCell (double value)
        {
        ...
        private ICell GetCell (string value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
        ...
        private ICell GetCell (bool value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
        ...
        private ICell GetCell (DateTime value)
        {
            var book = new XSSFWorkbook();
            var cell = book.CreateSheet ("0").CreateRow (0).CreateCell (0);
            cell.SetCellValue (value);
